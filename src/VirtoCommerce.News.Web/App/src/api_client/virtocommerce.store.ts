        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                ...
                for (let item of resultData200)
                    result200!.push(StoreAuthenticationScheme.fromJS(item));
            }
            else {
                result200 = <any>null;
            }
...
export class StoreModuleClient extends AuthApiBase {
    ...
    getStoreByOuterId(outerId: string, responseGroup?: string | undefined): Promise<Store> {
        ...
        if (outerId === undefined || outerId === null)
            throw new Error("The parameter 'outerId' must be defined.");
    ...
    protected processGetStorePublicSettingsById(response: Response): Promise<ModulePublicStoreSettings[]> {
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                result200 = [] as any;
                for (let item of resultData200)
                    result200!.push(ModulePublicStoreSettings.fromJS(item));
            }
            else {
                result200 = <any>null;
            }
...
export class ModulePublicStoreSettings implements IModulePublicStoreSettings {
    moduleId?: string | undefined;
    settings?: PublicStoreSetting[] | undefined;

    constructor(data?: IModulePublicStoreSettings) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
        ...
        if (_data) {
            ...
            if (Array.isArray(_data["settings"])) {
                ...
                for (let item of _data["settings"])
                    this.settings!.push(PublicStoreSetting.fromJS(item));
            }
        }
    }

    static fromJS(data: any): ModulePublicStoreSettings {
        data = typeof data === 'object' ? data : {};
        let result = new ModulePublicStoreSettings();
        result.init(data);
        return result;
    }
...
export interface IModulePublicStoreSettings {
    moduleId?: string | undefined;
    settings?: PublicStoreSetting[] | undefined;
}
...
export class PublicStoreSetting implements IPublicStoreSetting {
    name?: string | undefined;
    value?: any | undefined;

    constructor(data?: IPublicStoreSetting) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): PublicStoreSetting {
        data = typeof data === 'object' ? data : {};
        let result = new PublicStoreSetting();
        result.init(data);
        return result;
    }
...
export interface IPublicStoreSetting {
    name?: string | undefined;
    value?: any | undefined;
}
...
export class StoreAuthenticationScheme implements IStoreAuthenticationScheme {
    storeId?: string | undefined;
    name?: string | undefined;
    displayName?: string | undefined;
    isActive?: boolean;
    ...
    constructor(data?: IStoreAuthenticationScheme) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): StoreAuthenticationScheme {
        data = typeof data === 'object' ? data : {};
        let result = new StoreAuthenticationScheme();
        result.init(data);
        return result;
    }
...
export interface IStoreAuthenticationScheme {
    storeId?: string | undefined;
    name?: string | undefined;
    displayName?: string | undefined;
    isActive?: boolean;
