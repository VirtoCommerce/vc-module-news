    ...
    if (status === 200) {
      return response.text().then((_responseText) => {
        ...
        result200 =
          _responseText === ""
            ? null
            : (JSON.parse(_responseText, this.jsonParseReviver) as StoreAuthenticationScheme[]);
        return result200;
      });
    } else if (status === 401) {
      return response.text().then((_responseText) => {
  ...
  protected processSearchStores(response: Response): Promise<StoreSearchResult> {
    ...
    if (status === 200) {
      return response.text().then((_responseText) => {
        let result200: any = null;
        result200 =
          _responseText === "" ? null : (JSON.parse(_responseText, this.jsonParseReviver) as StoreSearchResult);
        return result200;
      });
    } else if (status === 401) {
      return response.text().then((_responseText) => {
  ...
  protected processGetLoginOnBehalfInfo(response: Response): Promise<LoginOnBehalfInfo> {
    ...
    if (status === 200) {
      return response.text().then((_responseText) => {
        let result200: any = null;
        result200 =
          _responseText === "" ? null : (JSON.parse(_responseText, this.jsonParseReviver) as LoginOnBehalfInfo);
        return result200;
      });
    } else if (status === 401) {
      return response.text().then((_responseText) => {
    ...
    if (status === 200) {
      return response.text().then((_responseText) => {
        ...
        result200 =
          _responseText === ""
            ? null
            : (JSON.parse(_responseText, this.jsonParseReviver) as ModulePublicStoreSettings[]);
        return result200;
      });
    } else if (status !== 200 && status !== 204) {
      return response.text().then((_responseText) => {
