...
export class AppManifestClient extends AuthApiBase {
  ...
  getManifest(appId: string): Promise<AppManifestResponse> {
    ...
    if (appId === undefined || appId === null) throw new globalThis.Error("The parameter 'appId' must be defined.");
  ...
  protected processGetManifest(response: Response): Promise<AppManifestResponse> {
    ...
    if (status === 200) {
      return response.text().then((_responseText) => {
        let result200: any = null;
        result200 =
          _responseText === "" ? null : (JSON.parse(_responseText, this.jsonParseReviver) as AppManifestResponse);
        return result200;
      });
    } else if (status !== 200 && status !== 204) {
      return response.text().then((_responseText) => {
  ...
  protected processGetUsersByIds(response: Response): Promise<ApplicationUser[]> {
    ...
    if (status === 200) {
      return response.text().then((_responseText) => {
        let result200: any = null;
        result200 =
          _responseText === "" ? null : (JSON.parse(_responseText, this.jsonParseReviver) as ApplicationUser[]);
        return result200;
      });
    } else if (status === 401) {
      return response.text().then((_responseText) => {
...
export class SettingsV2Client extends AuthApiBase {
  ...
  getGlobalSchema(moduleId?: string | undefined, keyword?: string | undefined): Promise<SettingPropertySchema[]> {
    ...
    if (moduleId === null) throw new globalThis.Error("The parameter 'moduleId' cannot be null.");
  ...
  protected processGetGlobalSchema(response: Response): Promise<SettingPropertySchema[]> {
    ...
    if (status === 200) {
      return response.text().then((_responseText) => {
        let result200: any = null;
        result200 =
          _responseText === "" ? null : (JSON.parse(_responseText, this.jsonParseReviver) as SettingPropertySchema[]);
        return result200;
      });
    } else if (status === 401) {
      return response.text().then((_responseText) => {
  ...
  getGlobalValues(modifiedOnly?: boolean | undefined, moduleId?: string | undefined): Promise<void> {
    ...
    if (modifiedOnly === null) throw new globalThis.Error("The parameter 'modifiedOnly' cannot be null.");
    else if (modifiedOnly !== undefined) url_ += "modifiedOnly=" + encodeURIComponent("" + modifiedOnly) + "&";
    if (moduleId === null) throw new globalThis.Error("The parameter 'moduleId' cannot be null.");
    else if (moduleId !== undefined) url_ += "moduleId=" + encodeURIComponent("" + moduleId) + "&";
    url_ = url_.replace(/[?&]$/, "");
  ...
  saveGlobalValues(replaceAll?: boolean | undefined, body?: { [key: string]: any } | undefined): Promise<void> {
    let url_ = this.baseUrl + "/api/platform/settings/v2/global/values?";
    if (replaceAll === null) throw new globalThis.Error("The parameter 'replaceAll' cannot be null.");
    else if (replaceAll !== undefined) url_ += "replaceAll=" + encodeURIComponent("" + replaceAll) + "&";
    url_ = url_.replace(/[?&]$/, "");
  ...
  getTenantValues(
    tenantType: string,
    tenantId: string,
    modifiedOnly?: boolean | undefined,
    moduleId?: string | undefined,
  ): Promise<void> {
