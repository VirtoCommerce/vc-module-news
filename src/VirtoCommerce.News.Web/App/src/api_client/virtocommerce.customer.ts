  ...
  protected processSearchMember(response: Response): Promise<MemberSearchResult> {
    ...
    if (status === 200) {
      return response.text().then((_responseText) => {
        let result200: any = null;
        result200 =
          _responseText === "" ? null : (JSON.parse(_responseText, this.jsonParseReviver) as MemberSearchResult);
        return result200;
      });
    } else if (status === 401) {
      return response.text().then((_responseText) => {
  ...
  protected processInviteCustomers(response: Response): Promise<InviteCustomerResult> {
    ...
    if (status === 200) {
      return response.text().then((_responseText) => {
        let result200: any = null;
        result200 =
          _responseText === "" ? null : (JSON.parse(_responseText, this.jsonParseReviver) as InviteCustomerResult);
        return result200;
      });
    } else if (status === 401) {
      return response.text().then((_responseText) => {
  ...
  protected processGetInviteRoles(response: Response): Promise<CustomerRoleSearchResult> {
    ...
    if (status === 200) {
      return response.text().then((_responseText) => {
        let result200: any = null;
        result200 =
          _responseText === "" ? null : (JSON.parse(_responseText, this.jsonParseReviver) as CustomerRoleSearchResult);
        return result200;
      });
    } else if (status === 401) {
      return response.text().then((_responseText) => {
  ...
  protected processSearchContacts(response: Response): Promise<ContactSearchResult> {
    ...
    if (status === 200) {
      return response.text().then((_responseText) => {
        let result200: any = null;
        result200 =
          _responseText === "" ? null : (JSON.parse(_responseText, this.jsonParseReviver) as ContactSearchResult);
        return result200;
      });
    } else if (status === 401) {
      return response.text().then((_responseText) => {
  ...
  protected processSearchOrganizations(response: Response): Promise<OrganizationSearchResult> {
    ...
    if (status === 200) {
      return response.text().then((_responseText) => {
        let result200: any = null;
        result200 =
          _responseText === "" ? null : (JSON.parse(_responseText, this.jsonParseReviver) as OrganizationSearchResult);
        return result200;
      });
    } else if (status === 401) {
      return response.text().then((_responseText) => {
  ...
  protected processSearchVendors(response: Response): Promise<VendorSearchResult> {
    ...
    if (status === 200) {
      return response.text().then((_responseText) => {
        let result200: any = null;
        result200 =
          _responseText === "" ? null : (JSON.parse(_responseText, this.jsonParseReviver) as VendorSearchResult);
        return result200;
      });
    } else if (status === 401) {
      return response.text().then((_responseText) => {
    ...
    if (status === 200) {
      return response.text().then((_responseText) => {
        ...
        result200 =
          _responseText === ""
            ? null
            : (JSON.parse(_responseText, this.jsonParseReviver) as CustomerPreferenceSearchResult);
        return result200;
      });
    } else if (status === 401) {
      return response.text().then((_responseText) => {
  ...
  protected processCreate(response: Response): Promise<CustomerPreference> {
    ...
    if (status === 200) {
      return response.text().then((_responseText) => {
        let result200: any = null;
        result200 =
          _responseText === "" ? null : (JSON.parse(_responseText, this.jsonParseReviver) as CustomerPreference);
        return result200;
      });
    } else if (status === 401) {
      return response.text().then((_responseText) => {
