...
export class CustomerPreferenceClient extends AuthApiBase {
    ...
    protected processSearch(response: Response): Promise<CustomerPreferenceSearchResult> {
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = CustomerPreferenceSearchResult.fromJS(resultData200);
            return result200;
            });
        } else if (status === 401) {
            return response.text().then((_responseText) => {
    ...
    protected processCreate(response: Response): Promise<CustomerPreference> {
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = CustomerPreference.fromJS(resultData200);
            return result200;
            });
        } else if (status === 401) {
            return response.text().then((_responseText) => {
...
export class Contact implements IContact {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.defaultOrganizationId = _data["defaultOrganizationId"];
            this.currentOrganizationId = _data["currentOrganizationId"];
            this.selectedAddressId = _data["selectedAddressId"];
    ...
    toJSON(data?: any) {
        ...
        data["defaultOrganizationId"] = this.defaultOrganizationId;
        data["currentOrganizationId"] = this.currentOrganizationId;
        data["selectedAddressId"] = this.selectedAddressId;
...
export class CustomerPreference implements ICustomerPreference {
    ...
    static fromJS(data: any): CustomerPreference {
        data = typeof data === 'object' ? data : {};
        let result = new CustomerPreference();
        result.init(data);
        return result;
    }
...
export class CustomerPreferenceSearchCriteria implements ICustomerPreferenceSearchCriteria {
    userId?: string | undefined;
    name?: string | undefined;
    ...
    constructor(data?: ICustomerPreferenceSearchCriteria) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): CustomerPreferenceSearchCriteria {
        data = typeof data === 'object' ? data : {};
        let result = new CustomerPreferenceSearchCriteria();
        result.init(data);
        return result;
    }
...
export interface ICustomerPreferenceSearchCriteria {
    userId?: string | undefined;
    name?: string | undefined;
    responseGroup?: string | undefined;
    objectType?: string | undefined;
...
export class CustomerPreferenceSearchResult implements ICustomerPreferenceSearchResult {
    totalCount?: number;
    results?: CustomerPreference[] | undefined;

    constructor(data?: ICustomerPreferenceSearchResult) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            ...
            if (Array.isArray(_data["results"])) {
                this.results = [] as any;
                for (let item of _data["results"])
                    this.results!.push(CustomerPreference.fromJS(item));
            }
        }
    }

    static fromJS(data: any): CustomerPreferenceSearchResult {
        data = typeof data === 'object' ? data : {};
        let result = new CustomerPreferenceSearchResult();
        result.init(data);
        return result;
    }
...
export interface ICustomerPreferenceSearchResult {
    totalCount?: number;
    results?: CustomerPreference[] | undefined;
}
